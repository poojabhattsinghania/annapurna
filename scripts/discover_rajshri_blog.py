#!/usr/bin/env python3
"""
Discover recipe URLs from Rajshri Food blog (rajshrifood.com)
"""
...
BASE_URL = 'https://rajshrifood.com'
...
def filter_recipe_urls(urls):
    ...
    # Common patterns for recipe URLs on Rajshri Food
    recipe_patterns = [
        '/recipe/',
        '/recipes/',
        '-recipe',
    ...
    for url in urls:
        # Must be from rajshrifood.com domain
        if 'rajshrifood.com' not in url:
            continue
    ...
    # If no recipe patterns, include all non-excluded URLs
    if not recipe_urls:
        for url in urls:
            if 'rajshrifood.com' not in url:
                continue
...
def main():
    print("🔍 Rajshri Food Blog Recipe Discovery")
    print("=" * 70)
    print()
    ...
    # Save to file
    output_file = 'rajshrifood_blog_urls.txt'
