...
from annapurna.api import (
    ...
    monitoring, feedback, recommendations, nutrition, onboarding, interactions, taste_profile, mobile, auth, whatsapp
)
...
app.include_router(whatsapp.router, prefix=f"/{settings.api_version}/whatsapp", tags=["WhatsApp"])
